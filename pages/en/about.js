...
const SectionTitle = ({ children }) => (
  <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">{children}</h2>
);
    ...
    <>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 sm:p-12 max-w-4xl mx-auto">
        <div className="text-center border-b pb-10 mb-10">
          <h1 
            className="text-4xl sm:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-400" 
            dangerouslySetInnerHTML={{ __html: t('about:hero_title') }} 
          />
          <p 
            className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto" 
            dangerouslySetInnerHTML={{ __html: t('about:hero_subtitle') }} 
          />
          <div className="mt-8">
            <a 
              href="https://gemini.google.com/gem/storybook" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="inline-block px-8 py-4 text-lg font-bold text-white bg-blue-600 rounded-full shadow-lg hover:bg-blue-700 transform hover:scale-105 transition-all"
            >
              {t('about:cta_button')}
            </a>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <FeatureCard 
              ...
              description={t('about:feature_4_desc')} 
            />
          </div>
        </div>
